...
import com.raul.macias.wikiheroes.databinding.ActivitySearchBinding
...
import com.raul.macias.wikiheroes.view.adapter.SearchAdapter
...
class SearchActivity : AppCompatActivity(), SearchObjectCharacterViewHolder.Delegate, SearchObjectComicViewHolder.Delegate, SearchObjectSeriesViewHolder.Delegate, SearchObjectCreatorViewHolder.Delegate {
    ...
    private val viewModel by lazy { ViewModelProvider(this, viewModelFactory).get(SearchActivityViewModel::class.java) }
