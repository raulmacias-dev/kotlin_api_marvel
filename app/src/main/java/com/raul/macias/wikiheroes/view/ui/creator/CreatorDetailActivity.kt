...
import com.raul.macias.wikiheroes.databinding.ActivityCreatorBinding
...
class CreatorDetailActivity : AppCompatActivity(), DetailViewHolder.Delegate {
    ...
    private val viewModel by lazy { ViewModelProvider(this, viewModelFactory).get(CreatorDetailViewModel::class.java) }
