...
import com.raul.macias.wikiheroes.databinding.ActivityDetailBinding
...
class DetailActivity : AppCompatActivity() {
    ...
    private val viewModel by lazy { ViewModelProvider(this, viewModelFactory).get(DetailActivityViewModel::class.java) }
