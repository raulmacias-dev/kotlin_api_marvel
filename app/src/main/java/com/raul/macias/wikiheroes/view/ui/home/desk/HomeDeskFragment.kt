...
import com.raul.macias.wikiheroes.databinding.FragmentHomeDeskBinding
import com.raul.macias.wikiheroes.factory.AppViewModelFactory
import com.raul.macias.wikiheroes.models.*
import com.raul.macias.wikiheroes.utils.ItemOffsetDecoration
...
class HomeDeskFragment : Fragment() , DeskComicViewHolder.Delegate , FavCharacterViewHolder.Delegate , DeskSeriesViewHolder.Delegate , FavCreatorViewHolder.Delegate {
    ...
    private val viewModel by lazy { ViewModelProvider(this, viewModelFactory).get(HomeDeskViewModel::class.java) }
