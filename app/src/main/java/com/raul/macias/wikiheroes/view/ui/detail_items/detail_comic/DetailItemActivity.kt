...
import com.raul.macias.wikiheroes.databinding.ComicDetailBinding
...
class DetailItemActivity : AppCompatActivity() {
    ...
    private val viewModel by lazy { ViewModelProvider(this, viewModelFactory).get(DetailItemViewModel::class.java) }
