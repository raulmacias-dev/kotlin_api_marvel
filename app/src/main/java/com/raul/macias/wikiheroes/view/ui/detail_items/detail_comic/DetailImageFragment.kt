...
import com.raul.macias.wikiheroes.databinding.FragmentDetailImageBinding
...
class DetailImageFragment : Fragment() {
    ...
    private val viewModel by lazy { ViewModelProvider(this, viewModelFactory).get(DetailImageViewModel::class.java) }
