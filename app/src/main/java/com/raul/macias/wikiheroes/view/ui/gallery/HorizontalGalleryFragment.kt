...
import com.raul.macias.wikiheroes.databinding.FragmentHorizontalGalleryBinding
...
class HorizontalGalleryFragment : Fragment() , DetailViewHolder.Delegate {
    ...
    private val viewModel by lazy { ViewModelProvider(this, viewModelFactory).get(HorizontalGalleryViewModel::class.java)}
